...
class Title(models.Model):
    ...
    subtitle3 = models.CharField('Testomonials Subtitle', max_length=50)
    title4 = models.CharField('Contact Title', max_length=40)
    colored_title4 = models.CharField('Contact Colored Title', max_length=40)
    subtitle4 = models.CharField('Contact Subtitle', max_length=50)
...
class Info(models.Model):
    ...
    subtitle = models.CharField('Contact Subtitle', max_length=50)
